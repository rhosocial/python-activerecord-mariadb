# src/rhosocial/activerecord/backend/impl/mariadb/__main__.py
"""MariaDB backend command-line interface.
...
def _build_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Execute SQL queries against a MariaDB backend.",
...
def main(argv=None):
    ...
    if args.command is None:
        ...
        print(
            f"Error: Please specify a command: {cmd_list}, "
            f"or '{COMMAND_NAMES[-1]}'",
            file=sys.stderr
        )
