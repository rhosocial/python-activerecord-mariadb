#!/usr/bin/env bash
# ===========================================================================
# demo_basic.sh — single migration basic operations (MariaDB)
#
# Scenarios:
...
#   DEMO_VENV_PYTHON=.venv3.13/bin/python \
#     PYTHONPATH=src \
#     bash src/rhosocial/activerecord/backend/impl/mariadb/examples/named_migrations/demo_basic.sh
# ===========================================================================
set -euo pipefail
...
rm -f "$STORE"
echo "=== Single Migration Basic Operations Complete (MariaDB) ==="
