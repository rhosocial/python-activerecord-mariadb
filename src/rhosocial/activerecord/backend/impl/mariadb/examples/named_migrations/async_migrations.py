# src/rhosocial/activerecord/backend/impl/mariadb/examples/named_migrations/async_migrations.py
"""
AsyncNamedMigration subclasses for MariaDB migration examples.
