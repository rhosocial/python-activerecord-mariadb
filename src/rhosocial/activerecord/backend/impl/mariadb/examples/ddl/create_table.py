...
create_expr = CreateTableExpression(
    ...
    indexes=indexes,
    if_not_exists=True,
    table_options=MariaDBCreateTableOptions(dialect, engine="InnoDB", charset="utf8mb4"),
)
...
# 2. MariaDB table options (engine/charset) are typed on MariaDBCreateTableOptions
