# src/rhosocial/activerecord/backend/impl/mariadb/cli/query.py
...
def _execute_query_sync(sql_query: str, backend: MariaDBBackend, provider, **kwargs):
...
async def _execute_query_async(sql_query: str, backend: AsyncMariaDBBackend, provider, **kwargs):
