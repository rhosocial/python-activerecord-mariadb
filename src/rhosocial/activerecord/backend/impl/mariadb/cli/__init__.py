# src/rhosocial/activerecord/backend/impl/mariadb/cli/__init__.py
"""MariaDB CLI common definitions and subcommand registration."""

import importlib

COMMAND_NAMES = [
    'info', 'query', 'introspect', 'status',
    'named-expression', 'named-procedure', 'named-connection',
]
