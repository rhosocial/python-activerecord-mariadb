...
"""DDL expressions for the ``feature/query`` table group (MariaDB).

Each factory builds a :class:`CreateTableExpression` whose generated MariaDB
...
def to_sql(expr: CreateTableExpression):
    return _common.to_mariadb_ddl_sql(expr)
...
def create_orders_table(dialect, table_name: str = "orders") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "user_id", IntegerType(dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "order_number", VarCharType(dialect, 255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
    ...
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "order_id", IntegerType(dialect),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
            ColumnDefinition(dialect, "product_name", VarCharType(dialect, 255),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL)]),
...
def create_profiles_table(dialect, table_name: str = "profiles") -> CreateTableExpression:
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "avatar_url", VarCharType(dialect, 512)),
            ColumnDefinition(dialect, "created_at", DateTimeType(dialect, precision=6)),
            ColumnDefinition(dialect, "updated_at", DateTimeType(dialect, precision=6)),
        ],
        table_constraints=[
    ...
    return CreateTableExpression(
        ...
        columns=[
            ...
            ColumnDefinition(dialect, "status", VarCharType(dialect, 50),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
                             ColumnConstraint(dialect, ColumnConstraintType.DEFAULT, default_value="pending")]),
            ColumnDefinition(dialect, "priority", VarCharType(dialect, 50),
                constraints=[ColumnConstraint(dialect, ColumnConstraintType.NOT_NULL),
            ...
            ColumnDefinition(dialect, "category", VarCharType(dialect, 255)),
            ColumnDefinition(dialect, "product", VarCharType(dialect, 255)),
            ColumnDefinition(dialect, "department", VarCharType(dialect, 255)),
            ColumnDefinition(dialect, "year", VarCharType(dialect, 10)),
            ColumnDefinition(dialect, "quarter", VarCharType(dialect, 10)),
            ColumnDefinition(dialect, "created_at", DateTimeType(dialect, precision=6)),
            ColumnDefinition(dialect, "updated_at", DateTimeType(dialect, precision=6)),
        ],
        indexes=[
