# tests/rhosocial/activerecord_mariadb_test/feature/backend/mariadb/spatial/test_spatial_expressions.py
"""
...
class TestMySQLSTGeomFromTextExpression:
    """Test MariaDBSTGeomFromTextExpression class."""
    ...
    def test_st_geom_from_text_with_alias(self):
        ...
        expr = MariaDBSTGeomFromTextExpression(dialect, 'POINT(1 1)').as_('pt')
        sql, params = expr.to_sql()
    ...
    def test_st_geom_from_text_linestring(self):
        ...
        expr = MariaDBSTGeomFromTextExpression(dialect, 'LINESTRING(0 0, 1 1, 2 2)')
        sql, params = expr.to_sql()
...
class TestMySQLSTDistanceExpression:
    """Test MariaDBSTDistanceExpression class."""

    def test_st_distance_basic(self):
        """Test basic distance calculation."""
        dialect = MariaDBDialect(version=(8, 0, 0))
        
        expr = MariaDBSTDistanceExpression(dialect, 'pt1', 'pt2')
        sql, params = expr.to_sql()
    ...
    def test_st_distance_with_alias(self):
        ...
        expr = MariaDBSTDistanceExpression(dialect, 'pt1', 'pt2').as_('dist')
        sql, params = expr.to_sql()
...
class TestMySQLSTWithinExpression:
    """Test MariaDBSTWithinExpression class."""
    ...
    def test_st_within_with_alias(self):
        ...
        expr = MariaDBSTWithinExpression(dialect, 'geom1', 'geom2').as_('within')
        sql, params = expr.to_sql()
...
class TestMySQLSTContainsExpression:
    """Test MariaDBSTContainsExpression class."""
    ...
    def test_st_contains_with_alias(self):
        ...
        expr = MariaDBSTContainsExpression(dialect, 'geom1', 'geom2').as_('contains')
        sql, params = expr.to_sql()
