# tests/rhosocial/activerecord_mariadb_test/feature/backend/adapters/test_enum_adapter.py
"""
MySQL ENUM type adapter tests.

This module tests the MariaDB-specific ENUM adapter functionality.
"""
import pytest
...
class TestMySQLEnumAdapter:
    ...
    def test_use_int_storage_mode(self):
        ...
        adapter = MariaDBEnumAdapter(use_int_storage=True)
    ...
    def test_use_int_storage_mode_override(self):
        ...
        adapter = MariaDBEnumAdapter(use_int_storage=False)
