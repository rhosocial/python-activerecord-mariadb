# tests/rhosocial/activerecord_mariadb_test/feature/backend/introspection/test_introspection_views.py
"""
Tests for MariaDB view introspection.
...
class TestViewInfoDetails:
    ...
    def test_view_check_option(self, backend_with_view):
        ...
        assert view is not None
        # MariaDB views have check_option (NONE, LOCAL, CASCADED)
        # Default is NONE
