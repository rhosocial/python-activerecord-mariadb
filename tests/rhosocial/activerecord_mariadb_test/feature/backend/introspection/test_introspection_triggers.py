# tests/rhosocial/activerecord_mariadb_test/feature/backend/introspection/test_introspection_triggers.py
"""
Tests for MariaDB trigger introspection.
...
class TestListTriggers:
    ...
    def test_list_triggers_empty_database(self, mariadb_backend_single):
        """Test list_triggers on database without triggers."""
        triggers = mariadb_backend_single.introspector.list_triggers()
