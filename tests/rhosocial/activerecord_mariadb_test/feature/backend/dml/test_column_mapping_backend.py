# tests/rhosocial/activerecord_mariadb_test/feature/backend/dml/test_column_mapping_backend.py
import pytest
...
@pytest.fixture
def setup_mapped_users_table(mariadb_backend):
    """Fixture to create and drop a 'mapped_users' table for MySQL."""
    mariadb_backend.execute("DROP TABLE IF EXISTS mapped_users")
...
def test_insert_with_mapping(mariadb_backend, setup_mapped_users_table):
    """
...
def test_update_with_backend(mariadb_backend, setup_mapped_users_table):
    """
...
def test_fetch_with_combined_mapping_and_adapters(mariadb_backend, setup_mapped_users_table):
    """
