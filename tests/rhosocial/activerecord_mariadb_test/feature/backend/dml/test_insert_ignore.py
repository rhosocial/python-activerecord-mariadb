# tests/rhosocial/activerecord_mariadb_test/feature/backend/dml/test_insert_ignore.py
"""
MySQL INSERT IGNORE tests.

Tests for the MariaDB-specific INSERT IGNORE functionality which silently
...
class TestMariaDBInsertIgnore:
    """Synchronous INSERT IGNORE tests for MariaDB backend."""
    ...
    def test_supports_insert_ignore(self, mariadb_backend):
        """Test that MariaDB dialect supports INSERT IGNORE."""
        assert mariadb_backend.dialect.supports_insert_ignore() is True

    def test_insert_ignore_single_row_no_conflict(self, mariadb_backend, test_table):
    ...
    def test_insert_ignore_with_conflict(self, mariadb_backend, test_table):
    ...
    def test_insert_ignore_multiple_rows_partial_conflict(self, mariadb_backend, test_table):
        ...
        # Verify all rows
        rows = mariadb_backend.fetch_all("SELECT * FROM test_insert_ignore ORDER BY email")
    ...
    def test_insert_ignore_without_option(self, mariadb_backend, test_table):
...
class TestMariaDBAsyncInsertIgnore:
    """Asynchronous INSERT IGNORE tests for MariaDB backend."""
