# tests/rhosocial/activerecord_mariadb_test/feature/backend/dml/test_column_mapping_backend_async.py
import pytest
...
async def setup_mapped_users_table(async_mariadb_backend):
    """Async fixture to create and drop a 'mapped_users' table for MySQL."""
    await async_mariadb_backend.execute("DROP TABLE IF EXISTS mapped_users")
...
@pytest.mark.asyncio
async def test_async_insert_with_mapping(async_mariadb_backend, setup_mapped_users_table):
    """
...
@pytest.mark.asyncio
async def test_async_update_with_backend(async_mariadb_backend, setup_mapped_users_table):
    """
...
@pytest.mark.asyncio
async def test_async_fetch_with_combined_mapping_and_adapters(async_mariadb_backend, setup_mapped_users_table):
    """
